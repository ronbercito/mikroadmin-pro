        ...
        <Modal title="Nuevo router" onClose={() => setShow(false)}>
          <form onSubmit={save} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field label="TLS"><select value={form.use_tls} onChange={(e) => setForm({ ...form, use_tls: e.target.value === 'true' })} className="form-input"><option value="true">Sí (HTTPS)</option><option value="false">No (HTTP)</option></select></Field>
            </div>
