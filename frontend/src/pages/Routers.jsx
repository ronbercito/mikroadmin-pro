...
// Corrección: Valores por defecto usando el puerto nativo de MikroTik API (8728 sin TLS)
...
export default function Routers() {
  ...
  // Manejador dinámico para cambiar TLS y puerto automáticamente
  function handleTlsChange(e) {
    const isTls = e.target.value === 'true';
    setForm({
      ...form,
      use_tls: isTls,
      api_port: isTls ? 8729 : 8728 // Cambia el puerto por defecto según el TLS elegido
    });
  }
